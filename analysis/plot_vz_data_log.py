...
for dist_name in map_dist_names:
    ...
    ax.add_patch(PolygonPatch(simplified_polygon, facecolor=color_i, edgecolor='none', zorder=1))
...
fig1.savefig("plots/vz_%d_colormap_log.svg" % year, bbox_inches='tight')
plt.show()